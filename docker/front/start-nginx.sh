...
sed -e "s|^\(.*API_URL=\)CNAAS_FRONT_URL$|\1$CNAAS_FRONT_URL|" \
    ...
    -e "s|^\(.*FIRMWARE_REPO_URL=\)CNAAS_FIRMWARE_JSON_URL$|\1$CNAAS_FIRMWARE_REPO_URL|" \
    -e "s|^\(.*FIRMWARE_REPO_METADATA_URL=\)CNAAS_FIRMWARE_JSON_URL$|\1$CNAAS_FIRMWARE_REPO_METADATA_URL|" \
