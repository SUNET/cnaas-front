...
var dateRegEx = new RegExp('^([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2})?$');
...
class FirmwareStep3 extends React.Component {
  ...
  onClickStep3Abort = (e) => {
    ...
    var confirmButtonElem = document.getElementById("step3abortButton");
    ...
    return (
      <div className="task-container">
        ...
        <div className="task-collapsable">
          ...
          <Form>
            <div className="info">
              <button id="step3button" onClick={e => this.openConfirm(e)} disabled={disableStartButton}>
                Start reboots
              </button>
              <button id="step3abortButton" disabled={step3abortDisabled} onClick={e => this.onClickStep3Abort(e)}>
                Abort!
              </button>
            </div>
          </Form>
